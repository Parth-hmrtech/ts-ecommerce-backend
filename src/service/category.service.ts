...
const createCategory = async (
  { seller_id, category_name }: ICategoryCreate
): Promise<Category> => {
...
const updateCategory = async (
  { id, category_name }: ICategoryUpdate
): Promise<boolean> => {
...
const createSubCategory = async (
  { seller_id, ...subCategoryBody }: ISubCategoryCreate
): Promise<SubCategory> => {
...
const updateSubCategory = async (
  { id, sub_category_name }: ISubCategoryUpdate
): Promise<boolean> => {
